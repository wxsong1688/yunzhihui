    ...
    */
    ...
    public $last_page='末页';//尾页
     ...
     function next_page($style='p-next p-elem')
     {
         ...
         return '<span  style="display:none" class="'.$style.'">'.$this->next_page.'</span>';
     }
    ...
    function pre_page($style='p-prev p-elem')
    {
        ...
        return '<span style="display:none" class="'.$style.'">'.$this->pre_page.'</span>';
    }
    ...
    function show($mode=1)
    {
        switch ($mode)
        {
            case 1://上一页 1 2 3 4 5 下一页 第x页
                return $this->pre_page().$this->nowbar().$this->next_page().'&nbsp;<span class="p-elem p-item-go">共'.$this->totalpage.'页</span>';
                break;
...
/*----------------private function (私有方法)-----------------------------------------------------------*/
    ...
    */
    ...
    {
        return $this->url.'&type=project&pg='.$pagenum;
    }
